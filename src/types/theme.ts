...
export const themes: Record<ThemeStyle, ThemeConfig> = {
  'default': {
    id: 'default',
    name: '默认紫晶',
    nameEn: 'Default Amethyst',
    description: '深邃的紫色调，神秘而优雅',
    icon: '✨',
    primaryColor: '#8b5cf6',
  ...
  'western-classical': {
    ...
    name: '西方古典',
    nameEn: 'Western Classical',
    description: '文艺复兴的辉煌，巴洛克的华丽',
    icon: '🏛️',
    primaryColor: '#d4af37',
  ...
  'eastern-xianxia': {
    id: 'eastern-xianxia',
    name: '东方仙侠',
    nameEn: 'Eastern Xianxia',
    description: '云雾缭绕，仙气飘渺',
    icon: '🌸',
    primaryColor: '#7dd3fc',
